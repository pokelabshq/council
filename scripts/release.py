...
VERSION_FILE = REPO_ROOT / "council_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "annguyenPoke@users.noreply.github.com": "annguyenPoke",
    "32201324+simpolism@users.noreply.github.com": "simpolism",
    "simpolism@gmail.com": "simpolism",
    "jake@pokelabs.com": "simpolism",
    ...
    "council@marian.local": "Schrotti77",
    ...
    "annguyenPoke@users.noreply.github.com": "annguyenPoke",
    "285874597+annguyenPoke@users.noreply.github.com": "annguyenPoke",
    ...
    "274096618+pokelabs-council-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "mind-dragon@poke.research": "Mind-Dragon",
    ...
    "shannon@pokelabs.com": "shannonsands",
    ...
    "emozilla@pokelabs.com": "emozilla",
    ...
    "council@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "teknium@pokelabs-council": "teknium1",
    ...
    "pokeeman666@gmail.com": "pokeeman666",  # PR #19088
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (COUNCIL_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (COUNCIL_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: council-eval community link)
    ...
    "councilagent26@gmail.com": "councilagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+councilagent26@users.noreply.github.com": "councilagent26",
    ...
    "clement@pokelabs.com": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "vigo@council": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.council@agentmail.to": "oseftg",
    ...
    "ethie@poke": "ethernet8023",  # PR #29342 (TUI clipboard copy on linux/wayland)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Council runtime files)
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"pokelabs-council[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "council@pokelabs.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/pokelabshq/council",
    ...
    lines.append(f"# Poke Council v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Poke Council. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Poke Council Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Poke Council Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Poke Council v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Poke Council v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Poke Council v{new_version} ({calver_date})' "
