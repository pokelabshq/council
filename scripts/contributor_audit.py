...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Council\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@pokelabs.com",
    "cursoragent@cursor.com",
    "council@pokelabs.com",
    "council-audit@example.com",
    "council@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
