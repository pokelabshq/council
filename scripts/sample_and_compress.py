...
DEFAULT_DATASETS = [
    "PokeLabs/swe-terminus-agent-glm-kimi-minimax",
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "PokeLabs/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload PokeLabs/{output_name} {final_output}")
