#!/usr/bin/env python3
"""Build the Council Skills Index — a centralized JSON catalog of all skills.
...
`council skills search/install` can use it without hitting the GitHub API.
...
# Ensure COUNCIL_HOME is set (needed by tools/skills_hub.py imports)
