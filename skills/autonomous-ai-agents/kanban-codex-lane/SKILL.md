...
description: Use when a Council Kanban worker wants to run Codex CLI as an isolated implementation lane while Council keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
author: Poke Council
license: MIT
metadata:
