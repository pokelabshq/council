...
Built for [Poke Council](https://github.com/pokelabshq/council). Usable in any coding agent. Canonical source lives here; synced to [`pokelabshq/council/skills/creative/ascii-video`](https://github.com/pokelabshq/council/tree/main/skills/creative/ascii-video) via PR.
