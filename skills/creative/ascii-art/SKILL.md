...
```bash
python3 -m pyfiglet "COUNCIL" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=COUNCIL&font=Slant" | boxes -d stone
```
