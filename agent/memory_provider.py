...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - council_home (str): The active COUNCIL_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.council``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "council").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'council memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], council_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'council memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``council_home`` is the active COUNCIL_HOME directory path.
