 ...
 *
 * Symptom: in `council --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@council/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using council --tui and as i type multiline my caret at the end will often ' +
