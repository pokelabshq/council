...
import type { ScrollBoxHandle } from '@council/ink'
import { evictInkCaches } from '@council/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.COUNCIL_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
