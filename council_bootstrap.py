"""Windows UTF-8 bootstrap for Council entry points.
...
# Apply on import — entry points just need ``import council_bootstrap``
# (or ``from council_bootstrap import apply_windows_utf8_bootstrap``) at
