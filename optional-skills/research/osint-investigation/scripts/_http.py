...
DEFAULT_UA = (
    "council-osint-investigation/0.2 "
    "(+https://github.com/pokelabshq/council; "
    "set COUNCIL_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("COUNCIL_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
