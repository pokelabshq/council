...
Data file: $COUNCIL_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_COUNCIL_HOME = Path(os.environ.get("COUNCIL_HOME", Path.home() / ".council"))
DATA_DIR = _COUNCIL_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
