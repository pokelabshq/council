...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("council_cli.config.get_config_path", return_value=config_path), \
             patch("council_cli.config.ensure_council_home"):
    ...
    def test_ensure_council_home_sets_0700(self):
        home = Path(self.tmpdir) / ".council"
        with patch("council_cli.config.get_council_home", return_value=home):
