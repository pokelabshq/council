"""Tests for _setup_feishu() in council_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("council_cli.gateway.save_env_value", side_effect=mock_save), \
         patch("council_cli.gateway.get_env_value", side_effect=mock_get), \
         patch("council_cli.gateway.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("council_cli.gateway.prompt_choice", side_effect=prompt_choice_responses), \
         patch("council_cli.gateway.prompt", side_effect=prompt_responses), \
         patch("council_cli.gateway.print_info"), \
         patch("council_cli.gateway.print_success"), \
         patch("council_cli.gateway.print_warning"), \
         patch("council_cli.gateway.print_error"), \
         patch("council_cli.gateway.color", side_effect=lambda t, c: t), \
         patch("gateway.platforms.feishu.qr_register", return_value=qr_result):

        from council_cli.gateway import _setup_feishu
        _setup_feishu()
