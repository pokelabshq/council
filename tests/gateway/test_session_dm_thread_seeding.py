...
def store(tmp_path, monkeypatch):
    ...
    ~/.council/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at council_state import time, before pytest's COUNCIL_HOME monkeypatch
    fires — the autouse fixture's COUNCIL_HOME override doesn't help here.)
    """
