...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("COUNCIL_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("COUNCIL_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("COUNCIL_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
