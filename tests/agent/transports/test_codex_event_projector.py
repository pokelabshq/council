"""Tests for CodexEventProjector — codex item/* events → Council messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Council' message alternation invariant."""
