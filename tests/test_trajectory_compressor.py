...
def test_import_loads_env_from_council_home(tmp_path, monkeypatch):
    home = tmp_path / ".council"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-council-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-council-home"
