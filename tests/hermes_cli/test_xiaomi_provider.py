...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from council_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in COUNCIL_OVERLAYS
        overlay = COUNCIL_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify council doctor recognizes Xiaomi env vars."""
