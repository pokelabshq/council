...
The notice prints the most recent curator run summary on `council update`,
...
session start) so users normally never see the rename map. `council update`
