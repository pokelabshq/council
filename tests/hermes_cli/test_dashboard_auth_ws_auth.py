...
class TestWsAuthOkGated:
    ...
    def test_rejection_audit_logs(self, gated_app, tmp_path, monkeypatch):
        ...
        from council_cli.dashboard_auth import audit as audit_mod
        ...
        # The audit module may write asynchropokely through stdlib logging,
        # but flush is synchropoke. If the file doesn't exist yet, the
