"""Tests for the interactive session browser (`council sessions browse`).
...
from council_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """council sessions browse should be parseable."""
