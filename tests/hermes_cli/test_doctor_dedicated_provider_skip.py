"""Regression: council doctor must not run a generic Bearer-auth health
...
def test_build_apikey_providers_list_skips_dedicated_check_providers():
    from council_cli import doctor
