...
The main() function in council_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `council -c model`
...
def _build_parser():
    """Build a minimal replica of the council top-level parser."""
