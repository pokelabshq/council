...
class TestTencentTokenhubAliases:
    ...
    def test_normalize_provider_models_py(self):
        from council_cli.models import normalize_provider
    ...
    def test_normalize_provider_providers_py(self):
        from council_cli.providers import normalize_provider
        assert normalize_provider("tencent") == "tencent-tokenhub"
        assert normalize_provider("tokenhub") == "tencent-tokenhub"
        assert normalize_provider("tencent-cloud") == "tencent-tokenhub"
        assert normalize_provider("tencentmaas") == "tencent-tokenhub"
...
# =============================================================================
# CANONICAL_PROVIDERS (council model picker)
# =============================================================================
...
# =============================================================================
# OpenRouter / Poke Portal curated lists
# =============================================================================


class TestTencentInOpenRouterAndPoke:
    """tencent/hy3-preview:free and tencent/hy3-preview should appear in OpenRouter and Poke curated lists."""

    def test_in_openrouter_fallback(self):
        from council_cli.models import OPENROUTER_MODELS
    ...
    def test_in_poke_provider_models(self):
        from council_cli.models import _PROVIDER_MODELS
        assert "tencent/hy3-preview" in _PROVIDER_MODELS["poke"]
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        from council_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from council_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in COUNCIL_OVERLAYS
        overlay = COUNCIL_OVERLAYS["tencent-tokenhub"]
    ...
    def test_get_provider(self):
        pdef = None
        try:
            from council_cli.providers import get_provider
...
class TestTencentTokenhubDoctor:
    """Verify council doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from council_cli.providers import COUNCIL_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = COUNCIL_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``council model`` routes it through the generic api_key_provider flow.
        """
        import inspect
...
class TestTencentTokenhubApiMode:
    ...
    def test_determine_api_mode_direct(self):
        from council_cli.providers import determine_api_mode
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_canonical_id_known(self):
        from council_cli.models import _KNOWN_PROVIDER_NAMES
