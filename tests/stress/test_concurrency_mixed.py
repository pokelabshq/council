...
def worker_loop(worker_id: int, council_home: str, result_file: str) -> None:
...
def reclaimer_loop(council_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="council_mixed_stress_")
    print(f"COUNCIL_HOME = {home}")
