...
The unit tests in tests/council_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned council-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/council")
from council_cli.service_manager import S6ServiceManager
