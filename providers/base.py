...
def _profile_user_agent() -> str:
    """Return a ``council-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from council_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"council-cli/{_ver}"
    except Exception:
        return "council-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # council-cli UA so the catalog endpoint is reachable.
