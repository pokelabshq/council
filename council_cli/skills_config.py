"""
Skills configuration for Poke Council.
`council skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.council/config.yaml under:
...
from council_cli.config import cfg_get, load_config, save_config
from council_cli.colors import Colors, color
from council_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `council skills`."""
    from council_cli.curses_ui import curses_checklist
