...
Visual styling mirrors the Poke Labs design system (the
``@pokelabs/ui`` package the React dashboard uses): the same
...
``tests/council_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Poke Council</title>
<style>
  /* Brand fonts shipped by @pokelabs/ui — same files the SPA loads. */
  @font-face {{
...
<body>
<main>
  <div class="brand">Poke<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Poke Council dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Poke Council</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
<p>Install <code>plugins/dashboard-auth-poke</code> (default) or another
