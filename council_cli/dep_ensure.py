...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_pokelabs_council_browser()
    ),
...
def _has_pokelabs_council_browser() -> bool:
    ...
    # install.sh installs globally into $COUNCIL_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-CouncilHome", str(get_council_home()),
        ]
    else:
