...
Usage:
    council pairing list              # Show all pending + approved users
    council pairing approve <platform> <code>  # Approve a pairing code
    council pairing revoke <platform> <user_id> # Revoke user access
    council pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle council pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: council pairing {list|approve|revoke|clear-pending}")
        print("Run 'council pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.council/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'council pairing list' to see pending codes.\n")
