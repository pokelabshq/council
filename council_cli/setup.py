...
_DOCS_BASE = "https://ai-council.pokelabs.com/docs"
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://ai-council.pokelabs.com/docs/user-guide/messaging/slack/")
    print()
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://ai-council.pokelabs.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://ai-council.pokelabs.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
