#!/usr/bin/env python3
"""
SWE Runner with Council Trajectory Format

A runner that uses Council-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Council-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Council-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Council format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Council-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Council-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Council Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Council-Agent's built-in execution environments
    and outputs trajectories in Council-Agent format.
    """
    ...
    def _convert_to_council_format(
        self,
        ...
        """
        Convert internal message format to Council trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Council trajectory format
        trajectory = self._convert_to_council_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Council trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Council Trajectory Format")
    print("=" * 60)
