...
const STORAGE_KEY = "council-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `council_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "council-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-council-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-council-theme-font", "true");
