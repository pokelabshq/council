 ...
 * `window.__COUNCIL_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Council brand in the top bar
 ...
 *  `window.__COUNCIL_PLUGINS__.registerSlot(...)`.
 *
