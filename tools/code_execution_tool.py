...
def execute_code(
    ...
    try:
        ...
        # Ensure the ai-council root is importable in the sandbox so
...
def _get_execution_mode() -> str:
    ...
    Mode semantics:
      ...
      - ``strict``: scripts run in an isolated temp directory with
        ``sys.executable`` (ai-council's python). Reproducible and the
...
def build_execute_code_schema(enabled_sandbox_tools: set = None,
    ...
    # temp-dir staging and ai-council's own python.
    if mode == "strict":
        cwd_note = (
