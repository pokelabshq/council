...
the get_anchored_view / get_messages_around primitives in council_state.
...
# Third-party integrations tag their sessions with COUNCIL_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from council_state import DEFAULT_DB_PATH
