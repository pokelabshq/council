...
Trust levels:
  - builtin:   Ships with Council. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.council/\.env|\~/\.council/\.env',
     "council_env_access", "critical", "exfiltration",
     "directly references Council secrets file"),
    ...
    (r'\.council/config\.yaml|\.council/SOUL\.md',
     "council_config_mod", "critical", "persistence",
     "references Council configuration files directly"),
