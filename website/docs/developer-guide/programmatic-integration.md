...
description: "Three protocols for driving ai-council from external programs: ACP, the TUI gateway JSON-RPC, and the OpenAI-compatible HTTP API"
---
...
GET  /v1/models                  Lists ai-council
