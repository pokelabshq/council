...
| | |
|---|---|
| Source | Optional — install with `council skills install official/health/neuroskill-bci` |
...
Connect Council to a running [NeuroSkill](https://neuroskill.com/) instance to read
