...
| | |
|---|---|
| Source | Optional — install with `council skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Poke Council (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $COUNCIL_OSINT_CACHE/icij/ (default: ~/.cache/council-osint/icij/).
...
# Set COUNCIL_OSINT_UA=your-app/1.0 (your@email) to identify yourself
