...
| | |
|---|---|
| Source | Optional — install with `council skills install official/research/qmd` |
...
Poke Council via the native MCP client. This is the preferred
...
Then configure Poke Council to connect via HTTP:
