...
| | |
|---|---|
| Source | Optional — install with `council skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Poke Council |
| License | MIT |
...
The script reads `~/.council/.env` for two optional defaults:
...
Helper script: `~/.council/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.council/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.council/.env`.
...
```bash
python3 ~/.council/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.council/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
