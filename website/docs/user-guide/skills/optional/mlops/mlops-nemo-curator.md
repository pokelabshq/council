...
| | |
|---|---|
| Source | Optional — install with `council skills install official/mlops/nemo-curator` |
...
- **[Filtering Guide](https://github.com/pokelabshq/council/blob/main/optional-skills/mlops/nemo-curator/references/filtering.md)** - 30+ quality filters, heuristics
- **[Deduplication Guide](https://github.com/pokelabshq/council/blob/main/optional-skills/mlops/nemo-curator/references/deduplication.md)** - Exact, fuzzy, semantic methods
