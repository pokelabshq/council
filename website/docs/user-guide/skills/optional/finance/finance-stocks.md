...
| | |
|---|---|
| Source | Optional — install with `council skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Poke Council |
| License | MIT |
...
```
SCRIPT=~/.council/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.council/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
