...
- User wants **Council itself to drive a browser** → use Council' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
