...
Set your Tenor API key in your environment (add to `~/.council/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/pokelabshq/council/blob/main/skills/media/gif-search/url)`
