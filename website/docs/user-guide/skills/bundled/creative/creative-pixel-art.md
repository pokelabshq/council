...
```python
import sys
sys.path.insert(0, "/home/teknium/.council/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.council/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Council installs package this)
