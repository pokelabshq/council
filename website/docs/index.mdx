...
slug: /
sidebar_position: 0
title: "Poke Council Documentation"
description: "The self-improving AI agent built by Poke Labs. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Poke Labs](https://pokelabs.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/pokelabshq/council" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
After installing, run `council setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Poke Portal](/integrations/poke-portal).
:::

## What is Poke Council?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Council safely |
| 🧭 **[Use MCP with Council](/guides/use-mcp-with-council)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Council](/guides/use-voice-mode-with-council)** | Hands-on setup and usage patterns for Council voice workflows |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)** | Define Council' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/guides/tips)** | Quick wins to get the most out of Council |
...
- **Built by model trainers** — Created by [Poke Labs](https://pokelabs.com), the lab behind Council, Nomos, and Psyche. Works with [Poke Portal](https://portal.pokelabs.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Poke Portal](/integrations/poke-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Poke Labs](https://pokelabs.com) — the lab behind Council, Nomos, and Psyche models
