---
sidebar_position: 7
title: "Use SOUL.md with Council"
description: "How to use SOUL.md to shape Poke Council's default voice, what belongs there, and how it differs from AGENTS.md and /personality"
---

# Use SOUL.md with Council

`SOUL.md` is the **primary identity** for your Council instance. It's the first thing in the system prompt — it defines who the agent is, how it speaks, and what it avoids.

If you want Council to feel like the same assistant every time you talk to it — or if you want to replace the Council persona entirely with your own — this is the file to use.
...
- personality
- communication style
- how direct or warm Council should be
- what Council should avoid stylistically
- how Council should relate to uncertainty, disagreement, and ambiguity

In short:
- `SOUL.md` is about who Council is and how Council speaks
...
Council now uses only the global SOUL file for the current instance:

```text
~/.council/SOUL.md
```

If you run Council with a custom home directory, it becomes:
...
Council automatically seeds a starter `SOUL.md` for you if one does not already exist.

That means most users now begin with a real file they can read and edit immediately.

Important:
- if you already have a `SOUL.md`, Council does not overwrite it
- if the file exists but is empty, Council adds nothing from it to the prompt

## How Council uses it

When Council starts a session, it reads `SOUL.md` from `COUNCIL_HOME`, scans it for prompt-injection patterns, truncates it if needed, and uses it as the **agent identity** — slot #1 in the system prompt. This means SOUL.md completely replaces the built-in default identity text.
...
That alone can noticeably change how Council feels.
...
Council already tries to be helpful and clear. `SOUL.md` should add real personality and style, not restate obvious defaults.
...
# Style
How Council should sound.

# Avoid
What Council should not do.

# Defaults
How Council should behave when ambiguity appears.
```
...
Then restart Council or start a new session.
...
### I edited SOUL.md but Council still sounds the same

Check:
- you edited `~/.council/SOUL.md` or `$COUNCIL_HOME/SOUL.md`
...
### Council is ignoring parts of my SOUL.md
