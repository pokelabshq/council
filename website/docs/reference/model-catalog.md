...
Council fetches curated model lists for **OpenRouter** and **Poke Portal** from a JSON manifest hosted alongside the docs site. This lets maintainers update picker lists without shipping a new `ai-council` release.
