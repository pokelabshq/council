  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Poke Council community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Council &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Council?{' '}
        <a
          href="https://github.com/pokelabshq/council/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/PokeLabs" target="_blank" rel="noopener noreferrer">
          Poke Labs Discord
        </a>{' '}
