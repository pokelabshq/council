...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'guides/run-council-with-poke-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-council',
        'guides/use-soul-with-council',
        'guides/use-voice-mode-with-council',
        'guides/build-a-council-plugin',
