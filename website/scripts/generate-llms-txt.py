#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Council docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Council as a Python Library", None),
        ("guides/use-mcp-with-council", "Use MCP with Council", None),
        ("guides/use-voice-mode-with-council", "Use Voice Mode with Council", None),
        ("guides/use-soul-with-council", "Use SOUL.md with Council", None),
        ("guides/build-a-council-plugin", "Build a Council Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Council"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Poke Council")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Poke Labs. A terminal-native "
        ...
        "backends. Works with Poke Portal, OpenRouter, OpenAI, Anthropic, Google, or any "
    ...
    lines.append("")
    lines.append("Repo: https://github.com/pokelabshq/council")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Poke Council — Full Documentation\n",
        (
            "This file is the entire Poke Council documentation concatenated for LLM "
