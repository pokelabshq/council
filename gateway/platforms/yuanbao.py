...
try:
    ...
    _COUNCIL_VERSION = "0.0.0"

_APP_VERSION = _COUNCIL_VERSION
_BOT_VERSION = _COUNCIL_VERSION
_YUANBAO_INSTANCE_ID = str(COUNCIL_INSTANCE_ID)  # single source: yuanbao_proto.COUNCIL_INSTANCE_ID
