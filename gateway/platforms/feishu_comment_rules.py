...
Config: ~/.council/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.council/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_council_home()`` helper (COUNCIL_HOME-aware and
...
RULES_FILE = get_council_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_council_home() / "feishu_comment_pairing.json"
