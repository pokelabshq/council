# Streaming LLM Response Support for Poke Council
...
```
COUNCIL_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("COUNCIL_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `council_cli/config.py` | 1 | +streaming config defaults |
...
COUNCIL_STREAMING_ENABLED=true
```
