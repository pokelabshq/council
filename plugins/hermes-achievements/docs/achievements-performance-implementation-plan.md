# Council Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.council/plugins/council-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.council/plugins/council-achievements/scan_checkpoint.json`.
