# Council Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.council/plugins/council-achievements/state.json` (existing unlock state)
  - `~/.council/plugins/council-achievements/scan_snapshot.json` (new)
  - `~/.council/plugins/council-achievements/scan_checkpoint.json` (new)
