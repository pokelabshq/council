...
Working directory: $COUNCIL_HOME/byterover/ (profile-scoped context tree)
"""
...
def _get_brv_cwd() -> Path:
    ...
    return get_council_home() / "byterover"
...
class ByteRoverMemoryProvider(MemoryProvider):
    ...
    def prefetch(self, query: str, *, session_id: str = "") -> str:
        """Run brv query synchropokely before the agent's first LLM call.
    ...
    def queue_prefetch(self, query: str, *, session_id: str = "") -> None:
        """No-op: prefetch() now runs synchropokely at turn start."""
        pass
