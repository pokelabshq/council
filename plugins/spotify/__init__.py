...
``_check_spotify_available()`` — when the user has not run ``council auth
spotify``, the tools remain registered (so they appear in ``council
...
The Spotify auth flow (``council auth spotify``), CLI plumbing, and docs
