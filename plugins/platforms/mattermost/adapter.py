...
required — uses aiohttp which is already a Council dependency.
...
def interactive_setup() -> None:
    ...
    ``council_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Council delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # council_cli/setup.py::_setup_mattermost function.
